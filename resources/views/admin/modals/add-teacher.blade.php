<!-- Fade In Modal -->
<div class="modal fade" id="add-teacher" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="block block-themed block-transparent remove-margin-b">
                    <div class="block-header bg-primary-dark">
                        ...
                        <h3 class="block-title">Thêm giáo viên</h3>
                    </div>
                    <div class="block-content">

                        <div class="form-group">
                            <label class="col-md-4 control-label" for="name">Tên giáo viên <span class="text-danger">*</span></label>
                            <div class="col-md-7">
