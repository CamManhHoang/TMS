...
namespace Illuminate\Support\Facades {
    ...
    class Hash {
        ...
        {
            return \App\Services\MD5Hasher::check($value, $hashedValue, $options);
        }
        ...
        public static function make($value, $options = array())
        {
            ...
            return \App\Services\MD5Hasher::make($value, $options);
        }
        ...
        {
            //Method inherited from \Illuminate\Hashing\BcryptHasher            
            return \App\Services\MD5Hasher::needsRehash($hashedValue, $options);
        }
        ...
        {
            //Method inherited from \Illuminate\Hashing\BcryptHasher            
            return \App\Services\MD5Hasher::setRounds($rounds);
        }
